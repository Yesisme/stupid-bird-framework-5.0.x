...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	//调用后置处理器applyBeanPostProcessorsBeforeInitialization方法之前
	...
	public void setBeanFactory(BeanFactory beanFactory) {
		...
		//调用完后初始化BeanFactory，
		//调用到@EnableAspectAutoProxy中像IOC容器的注册的bean的AnnotationAwareAspectJAutoProxyCreator的初始化方法
	...
	protected List<Advisor> findAdvisorsThatCanApply(
		...
		try {
			//寻找到需要LymApsect需要增加的方法，并加入到合适的拦截器列表
