...
public abstract class AbstractTraceInterceptor implements MethodInterceptor, Serializable {
	...
	/**
	 * Set whether to use a dynamic logger or a META-INF logger.
	 * Default is a META-INF logger for this trace interceptor.
	 ...
	 * {@code Class} getting called, or a META-INF one for the {@code Class}
