...
public class JamonPerformanceMonitorInterceptor extends AbstractMonitoringInterceptor {
	...
	/**
	 * Create a new JamonPerformanceMonitorInterceptor with a META-INF logger.
	 */
	public JamonPerformanceMonitorInterceptor() {
	}

	/**
	 * Create a new JamonPerformanceMonitorInterceptor with a dynamic or META-INF logger,
	 * according to the given flag.
	 * @param useDynamicLogger whether to use a dynamic logger or a META-INF logger
