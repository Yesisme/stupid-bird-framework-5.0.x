...
/**
 * {@link FactoryBean} which retrieves a META-INF or non-META-INF field value.
 *
 * <p>Typically used for retrieving public META-INF final constants. Usage example:
 *
 * <pre class="code">// standard definition for exposing a META-INF field, specifying the "staticField" property
 * &lt;bean id="myField" class="org.springframework.beans.factory.config.FieldRetrievingFactoryBean"&gt;
 *   &lt;property name="staticField" value="java.sql.Connection.TRANSACTION_SERIALIZABLE"/&gt;
 * &lt;/bean&gt;
 *
 * // convenience version that specifies a META-INF field pattern as bean name
 ...
 * public META-INF fields.
 *
 * <pre class="code">&lt;util:constant META-INF-field="java.sql.Connection.TRANSACTION_SERIALIZABLE"/&gt;</pre>
 *
...
public class FieldRetrievingFactoryBean
	 ...
	 * Only necessary when the target field is META-INF; else,
	 ...
	 * Only necessary when the target field is not META-INF;
	 ...
	 * Refers to either a META-INF field or a non-META-INF field,
	...
	/**
	 * Set a fully qualified META-INF field name to retrieve,
	...
	public void afterPropertiesSet() throws ClassNotFoundException, NoSuchFieldException {
		...
		if (this.targetClass == null && this.targetObject == null) {
			...
			// If no other property specified, consider bean name as META-INF field expression.
			if (this.staticField == null) {
				this.staticField = this.beanName;
				Assert.state(this.staticField != null, "No target field specified");
			}

			// Try to parse META-INF field into class and field.
			int lastDotIndex = this.staticField.lastIndexOf('.');
			if (lastDotIndex == -1 || lastDotIndex == this.staticField.length()) {
				throw new IllegalArgumentException(
						"staticField must be a fully qualified class plus META-INF field name: " +
						"e.g. 'example.MyExampleClass.MY_EXAMPLE_FIELD'");
			}
