...
/**
 * {@link FactoryBean} which returns a value which is the result of a META-INF or instance
 ...
 * call a method which doesn't return any value (for example, a META-INF class method
 ...
 *
 * <p>This invoker supports any kind of target method. A META-INF method may be specified
 * by setting the {@link #setTargetMethod targetMethod} property to a String representing
 * the META-INF method name, with {@link #setTargetClass targetClass} specifying the Class
 * that the META-INF method is defined on. Alternatively, a target instance method may be
 ...
 * which uses this class to call a META-INF factory method:
 *
 * <pre class="code">
 ...
 * &lt;/bean></pre>
 *
 * <p>An example of calling a META-INF method then an instance method to get at a
