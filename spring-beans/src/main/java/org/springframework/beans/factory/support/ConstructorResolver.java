...
class ConstructorResolver {
	 ...
	 * <p>Implementation requires iterating over the META-INF or instance methods with the
	...
	public BeanWrapper instantiateUsingFactoryMethod(
		...
		if (factoryBeanName != null) {
			...
			// It's a META-INF factory method on the bean class.
			if (!mbd.hasBeanClass()) {
				throw new BeanDefinitionStoreException(mbd.getResourceDescription(), beanName,
		...
		if (factoryMethodToUse == null || argsToUse == null) {
			...
			if (factoryMethodToUse == null) {
				...
				throw new BeanCreationException(mbd.getResourceDescription(), beanName,
						...
						(isStatic ? "META-INF" : "non-META-INF") + ".");
			}
	 ...
	 * <p>This method is also used for handling invocations of META-INF factory methods.
	 */
