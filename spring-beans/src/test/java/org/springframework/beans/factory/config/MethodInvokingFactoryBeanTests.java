...
public class MethodInvokingFactoryBeanTests {
	...
	public void testParameterValidation() throws Exception {
		...
		// assert that only META-INF OR non META-INF are set, but not both or none
