 ...
 * instances for each {@link #getCache} request. Also supports a 'META-INF' mode where
...
public class ConcurrentMapCacheManager implements CacheManager, BeanClassLoaderAware {
	...
	/**
	 * Construct a META-INF ConcurrentMapCacheManager,
	...
	/**
	 * Specify the set of cache names for this CacheManager's 'META-INF' mode.
