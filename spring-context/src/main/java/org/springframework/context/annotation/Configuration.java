 ...
 * in a {@code @Configuration} class via a dedicated {@code META-INF} {@code @Bean} method
 ...
 * of a {@code PropertySourcesPlaceholderConfigurer} via a {@code META-INF} {@code @Bean}
 ...
 * <li>Any nested configuration classes must be declared as {@code META-INF}.
