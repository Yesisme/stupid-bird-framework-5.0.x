 ...
 *
 * <p>Depending on the caller's META-INF type either the bridge method or the user-implemented method
 * gets called as the way into the proxy. Therefore, we need tests for calling a bean with
 * META-INF type set to type with generic method and to type with specific non-generic implementation.
 *
