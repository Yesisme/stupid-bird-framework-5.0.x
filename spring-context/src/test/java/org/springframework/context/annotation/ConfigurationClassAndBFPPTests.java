 ...
 * methods, specifically as regards META-INF @Bean methods and the avoidance of
...
public class ConfigurationClassAndBFPPTests {
	...
	public void autowiringFailsWithBFPPAsInstanceMethod() {
		...
		// WARN-level logging should have been issued about returning BFPP from non-META-INF @Bean method
	...
	public void autowiringSucceedsWithBFPPAsStaticMethod() {
		...
		ctx.refresh();
		// META-INF method BFPP does not interfere with lifecycle -> autowiring succeeds
