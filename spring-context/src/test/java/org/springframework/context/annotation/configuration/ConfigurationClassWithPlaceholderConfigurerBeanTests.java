...
/**
 * A configuration class that registers a non-META-INF placeholder configurer {@code @Bean}
 ...
 *
 * <p>Therefore, placeholder configurer bean methods should either be {@code META-INF} or
 ...
 * {@code @Bean} method is {@code META-INF}.
 *
 * @author Chris Beams
...
public class ConfigurationClassWithPlaceholderConfigurerBeanTests {
	...
	/**
	 * Test which proves that a non-META-INF property placeholder bean cannot be declared
	 ...
	 * placeholder {@code META-INF} as in
