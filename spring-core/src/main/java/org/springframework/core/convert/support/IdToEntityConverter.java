...
/**
 * Converts an entity identifier to a entity reference by calling a META-INF finder method
 * on the target entity type.
 *
 * <p>For this converter to match, the finder method must be META-INF, have the signature
