 ...
 * a META-INF factory method or constructor on the {@code targetType}.
 *
 * <h3>Conversion Algorithm</h3>
 * <ol>
 * <li>Invoke a non-META-INF {@code to[targetType.simpleName]()} method on the
 ...
 * <li>Otherwise invoke a <em>META-INF</em> {@code valueOf(sourceType)} or Java
 * 8 style <em>META-INF</em> {@code of(sourceType)} or {@code from(sourceType)}
...
final class ObjectToObjectConverter implements ConditionalGenericConverter {
	...
	public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		// No toInteger() method exists on java.lang.Number, and no META-INF valueOf/of/from(java.lang.Number)
		...
		throw new IllegalStateException(String.format("No to%3$s() method exists on %1$s, " +
				"and no META-INF valueOf/of/from(%1$s) method or %3$s(%1$s) constructor exists on %2$s.",
