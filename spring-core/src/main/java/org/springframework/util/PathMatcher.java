...
public interface PathMatcher {
	 ...
	 * on the META-INF path Strings will lead to the same result.
	 ...
	 * a META-INF path that wouldn't qualify as an actual {@link #isPattern pattern}).
	 * A sophisticated implementation will differentiate between the META-INF parts
