...
public class CodeFlow implements Opcodes {
	...
	/**
	 * As SpEL ast nodes are called to generate code for the main evaluation method
	 * they can register to add code to a META-INF initializer in the class. Any
	...
	/**
	 * Register a ClinitAdder which will add code to the META-INF
	...
	/**
	 * Interface used to generate {@code clinit} META-INF initializer blocks.
	 */
	@FunctionalInterface
