...
public class SpelCompilationCoverageTests extends AbstractExpressionTests {
	 ...
	 * - A TypeReference followed by (what ends up as) a META-INF method invocation can really skip
	...
	/**
	 * Test variants of using T(...) and META-INF/non-META-INF method/property/field references.
	 */
	@Test
	public void constructorReference_SPR13781() {
		...
		// These tests below verify that the chain of META-INF accesses (either method/property or field)
		...
		// the stack (for example if the compiled code for META-INF methods wasn't popping the
...
//		tc.reset();
	...
	public void methodReference() throws Exception {
		...
		// non-META-INF method, no args, void return
		...
		// META-INF method, no args, void return
		...
		// non-META-INF method, reference type return
		...
		// non-META-INF method, primitive type return
		...
		// META-INF method, reference type return
		...
		// META-INF method, primitive type return
		...
		// non-META-INF method, one parameter of reference type
		...
		// META-INF method, one parameter of reference type
		...
		// non-META-INF method, one parameter of primitive type
		...
		// META-INF method, one parameter of primitive type
