...
public interface JdbcOperations {
	...
	//-------------------------------------------------------------------------
	// Methods dealing with META-INF SQL (java.sql.Statement)
	//-------------------------------------------------------------------------
	 ...
	 * @param sql META-INF SQL to execute
	 * @throws DataAccessException if there is any problem
	 */
	void execute(String sql) throws DataAccessException;

	/**
	 * Execute a query given META-INF SQL, reading the ResultSet with a
	 * ResultSetExtractor.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	...
	/**
	 * Execute a query given META-INF SQL, reading the ResultSet on a per-row
	...
	/**
	 * Execute a query given META-INF SQL, mapping each row to a result object
	 * via a RowMapper.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	 * {@code query} method with {@code null} as argument array.
	...
	/**
	 * Execute a query given META-INF SQL, mapping a single result row to a
	...
	/**
	 * Execute a query for a result object, given META-INF SQL.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	 * {@link #queryForObject(String, Class, Object...)} method with
	 * {@code null} as argument array.
	 * <p>This method is useful for running META-INF SQL with a known outcome.
	...
	/**
	 * Execute a query for a result map, given META-INF SQL.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	...
	/**
	 * Execute a query for a result list, given META-INF SQL.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	...
	/**
	 * Execute a query for a SqlRowSet, given META-INF SQL.
	 * <p>Uses a JDBC Statement, not a PreparedStatement. If you want to
	 * execute a META-INF query with a PreparedStatement, use the overloaded
	 ...
	 * we run an update with META-INF SQL.
	 * @return the number of rows affected
	 * @throws DataAccessException if there is any problem issuing the update
	 */
