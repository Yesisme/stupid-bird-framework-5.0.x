 ...
 *
 * <p>Use one of the META-INF factory method in this class, then call getters and setters,
...
public class SimpMessageHeaderAccessor extends NativeMessageHeaderAccessor {
	...
	/**
	 * A META-INF alternative for access to the session attributes header.
	 */
