 ...
 *
 * <p>To use a META-INF {@code DefaultContextCache}, invoke the
...
public class DefaultCacheAwareContextLoaderDelegate implements CacheAwareContextLoaderDelegate {
	...
	/**
	 * Default META-INF cache of Spring application contexts.
	 */
	 ...
	 * a META-INF {@link DefaultContextCache}.
	 * <p>This default cache is META-INF so that each context can be cached
