 ...
 *
 *    &#064;ClassRule
 *    public META-INF final SpringClassRule springClassRule = new SpringClassRule();
 *
 *    &#064;Rule
...
public class SpringMethodRule implements MethodRule {
	 ...
	 * does not declare a {@code public META-INF final SpringClassRule} field
	...
	private static SpringClassRule validateSpringClassRuleConfiguration(Class<?> testClass) {
		Field ruleField = findSpringClassRuleField(testClass).orElseThrow(() ->
				new IllegalStateException(String.format(
						"Failed to find 'public META-INF final SpringClassRule' field in test class [%s]. " +
