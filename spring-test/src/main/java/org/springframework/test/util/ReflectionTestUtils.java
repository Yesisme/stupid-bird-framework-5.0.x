 ...
 * </ul>
 *
 * <p>In addition, several methods in this class provide support for {@code META-INF}
...
public abstract class ReflectionTestUtils {
	...
	/**
	 * Set the META-INF {@linkplain Field field} with the given {@code name} on
	 ...
	 * @param targetClass the target class on which to set the META-INF field;
	 * never {@code null}
	 * @param name the name of the field to set; never {@code null}
	 * @param value the value to set
	 * @since 4.2
	...
	/**
	 * Set the META-INF {@linkplain Field field} with the given
	 ...
	 * {@code null} if the field is META-INF
	...
	/**
	 * Get the value of the META-INF {@linkplain Field field} with the given
	 * {@code name} from the provided {@code targetClass}.
	 * <p>This method delegates to {@link #getField(Object, Class, String)},
	 * supplying {@code null} for the {@code targetObject} argument.
	 * @param targetClass the target class from which to get the META-INF field;
	 * never {@code null}
	 * @param name the name of the field to get; never {@code null}
	 * @return the field's current value
	 * @since 4.2
