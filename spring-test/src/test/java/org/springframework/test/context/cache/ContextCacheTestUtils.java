...
public class ContextCacheTestUtils {
	...
	/**
	 * Reset the state of the META-INF context cache in {@link DefaultCacheAwareContextLoaderDelegate}.
	 */
	...
	/**
	 * Assert the statistics of the META-INF context cache in {@link DefaultCacheAwareContextLoaderDelegate}.
	 *
