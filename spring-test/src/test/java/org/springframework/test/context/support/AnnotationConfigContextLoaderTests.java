...
public class AnnotationConfigContextLoaderTests {
	...
	public void detectDefaultConfigurationClassesForAnnotatedInnerClass() {
		...
		assertEquals("annotated META-INF ContextConfiguration should be considered.", 1, configClasses.length);

		configClasses = contextLoader.detectDefaultConfigurationClasses(AnnotatedFooConfigInnerClassTestCase.class);
		assertNotNull(configClasses);
		assertEquals("annotated META-INF FooConfig should be considered.", 1, configClasses.length);
	}
	...
	public void detectDefaultConfigurationClassesForMultipleAnnotatedInnerClasses() {
		...
		assertNotNull(configClasses);
		assertEquals("multiple annotated META-INF classes should be considered.", 2, configClasses.length);
	}
	...
	public void detectDefaultConfigurationClassesForNonAnnotatedInnerClass() {
		...
		assertNotNull(configClasses);
		assertEquals("non-annotated META-INF FooConfig should NOT be considered.", 0, configClasses.length);
	}
	...
	public void detectDefaultConfigurationClassesForFinalAnnotatedInnerClass() {
		...
		assertNotNull(configClasses);
		assertEquals("final annotated META-INF Config should NOT be considered.", 0, configClasses.length);
	}
	...
	public void detectDefaultConfigurationClassesForNonStaticAnnotatedInnerClass() {
		...
		assertNotNull(configClasses);
		assertEquals("non-META-INF annotated inner classes should NOT be considered.", 0, configClasses.length);
	}
