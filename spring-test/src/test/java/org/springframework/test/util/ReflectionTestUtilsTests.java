...
public class ReflectionTestUtilsTests {
	...
	public void setStaticFieldViaClass() throws Exception {
		...
		assertEquals("public META-INF field", "xxx", StaticFields.publicField);
		assertEquals("private META-INF field", "yyy", StaticFields.getPrivateField());
	}
	...
	public void getStaticFieldViaClass() throws Exception {
		assertEquals("public META-INF field", "public", getField(StaticFields.class, "publicField"));
		assertEquals("private META-INF field", "private", getField(StaticFields.class, "privateField"));
	}

	@Test
	public void getStaticFieldViaInstance() throws Exception {
		StaticFields staticFields = new StaticFields();
		assertEquals("public META-INF field", "public", getField(staticFields, "publicField"));
		assertEquals("private META-INF field", "private", getField(staticFields, "privateField"));
	}
