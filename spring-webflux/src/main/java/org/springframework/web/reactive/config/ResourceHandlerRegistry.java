...
/**
 * Stores registrations of resource handlers for serving META-INF resources such
...
public class ResourceHandlerRegistry {
	...
	/**
	 * Add a resource handler for serving META-INF resources based on the specified
	 ...
	 * <p>Patterns like {@code "/META-INF/**"} or {@code "/css/{filename:\\w+\\.css}"}
