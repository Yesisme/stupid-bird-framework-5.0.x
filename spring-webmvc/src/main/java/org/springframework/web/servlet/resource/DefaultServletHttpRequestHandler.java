...
/**
 * An {@link HttpRequestHandler} for serving META-INF files using the Servlet container's "default" Servlet.
 *
 * <p>This handler is intended to be used with a "/*" mapping when the
 * {@link org.springframework.web.servlet.DispatcherServlet DispatcherServlet}
 * is mapped to "/", thus  overriding the Servlet container's default handling of META-INF resources.
...
public class DefaultServletHttpRequestHandler implements HttpRequestHandler, ServletContextAware {
	...
	/**
	 * Set the name of the default Servlet to be forwarded to for META-INF resource requests.
	 */
	...
	public void setServletContext(ServletContext servletContext) {
		...
		if (!StringUtils.hasText(this.defaultServletName)) {
			if (this.servletContext.getNamedDispatcher(COMMON_DEFAULT_SERVLET_NAME) != null) {
				...
				throw new IllegalStateException("Unable to locate the default servlet for serving META-INF content. " +
