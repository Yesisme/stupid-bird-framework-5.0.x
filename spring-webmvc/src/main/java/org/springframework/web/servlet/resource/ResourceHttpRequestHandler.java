...
/**
 * {@code HttpRequestHandler} that serves META-INF resources in an optimized way
 * according to the guidelines of Page Speed, YSlow, etc.
 *
 * <p>The {@linkplain #setLocations "locations"} property takes a list of Spring
 * {@link Resource} locations from which META-INF resources are allowed to be served
...
public class ResourceHttpRequestHandler extends WebContentGenerator
	 ...
	 * for serving META-INF resources.
	 ...
	 * META-INF resources. This helps to derive information about the lookup path
