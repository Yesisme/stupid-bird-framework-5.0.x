...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	...
	/** Map of META-INF attributes, keyed by attribute name (String) */
	...
	/**
	 * Set META-INF attributes from a {@code java.util.Properties} object,
	...
	/**
	 * Set META-INF attributes from a Map, for all views returned by this resolver.
	...
	/**
	 * Allow Map access to the META-INF attributes for views returned by
